      ...
      <Drawer placement={'left'} isOpen={isOpen} onClose={onClose}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Menu>
              <MenuGroup>
                <MenuItem borderRadius={'10px'} pl={4} fontSize={'sm'} onClick={() => onClose()} _hover={{ bg: "rgba(255,0,0,0.1)" }} gap={'2'}><Link className='width-full' to={'/'}> Home</Link></MenuItem>
                <MenuItem borderRadius={'10px'} pl={4} fontSize={'sm'} onClick={() => onClose()} _hover={{ bg: "rgba(255,0,0,0.1)" }} gap={'2'}><Link className='width-full' to={'/about'}>About</Link></MenuItem>
                <MenuItem borderRadius={'10px'} pl={4} fontSize={'sm'} onClick={() => onClose()} _hover={{ bg: "rgba(255,0,0,0.1)" }} gap={'2'}><Link className='width-full' to={'/contact'}>Contact</Link></MenuItem>
                <MenuDivider />
              </MenuGroup>
            </Menu>
            <HStack>
